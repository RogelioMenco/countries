    ...
    <div data-testid="test" className="container">
      <div className="infoContainer">
        <div className="titleContainer">
          <h3 className="title">Acerca de esta página</h3>
        </div>
        <div className={style.content}>
          ...
          <p>
            Esta página es un proyecto individual para el bootcamp de SoyHenry.
          </p>
          <p>
            {' '}
            Aquí podrás encontrar información sobre todos los países del mundo,
            como la población, las actividades turísticas que puedes realizar
            allí y un sencillo juego de preguntas sobre las capitales de todos
            los países del mundo.
          </p>
          <p>
            Para crear esta página, tuve que seguir un archivo Léame con esas
            reglas:
          </p>
          <ul>
            <li className={style.list}>
              <p>
                ...
                <a
                  ...
                  href="http://localhost:5000/countries"
                  target="_blank"
                  rel="noreferrer"
                >
                  API countries.
            ...
            <li className={style.list}>
              <p>Guardar la información en una base de datos.</p>
            </li>
            <li className={style.list}>
              <p>Muestra información sobre países en la página de inicio.</p>
            </li>
            <li className={style.list}>
              <p>
                Añade filtros como buscar por nombre, ordenar alfabéticamente,
                etc.
              </p>
            </li>
            <li className={style.list}>
              <p>
                Crea actividades turísticas que puedas realizar en uno o más
                países a través de un formulario y almacena la información en
                una base de datos.
              </p>
            </li>
            <li className={style.list}>
              <p>Mostrar detalles sobre cada país.</p>
            </li>
            <li className={style.list}>
              <p>Utilice CSS básico.</p>
            </li>
          </ul>
          <div className={style.containerTechs}>
            <h4 className={style.title}>Tecnologías</h4>
          ...
          {/* <div className={style.aboutMeContainer}>
            ...
            <p>Hola Amigos</p>
            <p>soy Rogelio me gusta mucho la programacion.</p>
          </div> */}
        </div>
      </div>
    </div>
