...
const CreateActivity = () => {
  ...
  const changeLblDifficulty = (difficulty) => {
    const difficulties = [
      { name: 'Facil', className: style.veryEasy },
      { name: 'Amateur', className: style.easy },
      { name: 'Normal', className: style.normal },
      { name: 'Profesional', className: style.hard },
      { name: 'Experto', className: style.extreme },
    ];
      ...
      <div className={style.container}>
        <div className={style.infoContainer}>
          <div className={style.titleContainer}>
            <h3 className={style.title}>Nueva Actividad</h3>
          </div>
          <form action="" method="post" onSubmit={handleOnSubmit}>
            <FieldActivity
              ...
              id="name"
              text="Nombre"
              textWrong="Por favor ingresa un nombre"
            >
              <input
                autoComplete="off"
            ...
            <FieldActivity
              ...
              id="duration"
              text="Duracion en horas (Max: 24)"
              textWrong="Por favor agrega una duracion valida"
            >
              <input
            ...
            <FieldActivity
              ...
              id="season"
              text="Estacion"
              textWrong="Por favor selecciona una estacion"
            >
              <select
                ref={selectedSeason}
            ...
            <FieldActivity
              ...
              textWrong="Por favor selecciona almenos un pais"
            >
              <select
                  ...
                  <div className={style.selectedCountries}>
                    {newActivity.countries.all.length ? (
                      <div className={style.listCountriesContainer}>
                        {newActivity.countries?.all.map((country, i) => {
                      ...
                      <p className={style.noneCountry}>Ninguno</p>
                    )}
                  </div>
                </div>
              </div>
